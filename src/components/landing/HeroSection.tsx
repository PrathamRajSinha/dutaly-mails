    ...
    <section className="pt-32 pb-0 sm:pt-40">
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="mt-8 flex items-center gap-4">
          ...
          <a href="#how-it-works" className="text-[13px] text-zinc-500 hover:text-white transition-colors">
            See how it works →
          </a>
        </div>
      </div>
        ...
        <div className="rounded-t-xl border border-b-0 border-white/[0.08] bg-[#111113] overflow-hidden shadow-[0_0_80px_-20px_rgba(0,0,0,0.8)]">
          ...
          <div className="flex items-center gap-2 px-4 py-3 border-b border-white/[0.06] bg-[#0F0F11]">
            ...
            <div className="flex-1 flex justify-center">
              <div className="px-12 py-1 rounded-md bg-white/[0.04] text-[11px] text-zinc-600 font-mono">
                dutaly.com/inbox
              </div>
            </div>
          </div>
          ...
          <div className="flex min-h-[420px]">
            ...
            <div className="hidden sm:block w-[200px] border-r border-white/[0.06] p-3 space-y-1">
              ...
              <div className="px-3 py-1.5 text-[12px] text-zinc-600">Auto-Sent</div>
              <div className="px-3 py-1.5 text-[12px] text-zinc-600">Knowledge Base</div>
              <div className="px-3 py-1.5 text-[12px] text-zinc-600">Instructions</div>
              <div className="px-3 py-1.5 text-[12px] text-zinc-600">Templates</div>
              <div className="mt-6 px-3 py-1.5 text-[12px] text-zinc-600">Settings</div>
            </div>
            ...
            <div className="flex-1 border-r border-white/[0.06]">
              <div className="px-4 py-3 border-b border-white/[0.06] flex items-center justify-between">
                ...
                <span className="text-[11px] text-zinc-600">4 open</span>
              </div>
              {[
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] text-zinc-600 font-mono">{t.score} confidence</span>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="hidden lg:block w-[340px] p-4">
              <div className="mb-4">
                ...
                <span className="text-[11px] text-zinc-600">mike@startup.io</span>
              </div>
              ...
              <div className="p-3 rounded-lg bg-white/[0.03] border border-white/[0.06]">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-[11px] text-zinc-500">Suggested reply · 67% confidence</span>
                </div>
